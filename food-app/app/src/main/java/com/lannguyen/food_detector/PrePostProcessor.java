...
public class PrePostProcessor {
    ...
    private static int mOutputRow = 19200; // as decided by the YOLOv5 model for input image of size 640*640
    private static int mOutputColumn = 85; // left, top, right, bottom, score and 80 class probability
    private static float mThreshold = 0.15f; // score above which a detection is generated
